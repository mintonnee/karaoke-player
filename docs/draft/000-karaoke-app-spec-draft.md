...
DB 스키마 버전 호환성 검사, 마이그레이션 원자성, 사전 백업·실패 복구 계약은 [`007-db-schema-safety.md`](../specs/007-db-schema-safety.md)를 따른다 (구현 완료, 패키징 앱 수동 확인 대기). 복구 절차는 [`docs/db-recovery.md`](../db-recovery.md).
...
- S3.2 확장: 곡 수정 창의 키·BPM 재측정 상세는 `docs/specs/011-track-reanalysis.md`를 따른다 (구현 완료, 실제 앱 수동 확인 대기).
- S3.2 확장: 곡 수정 팝업과 앨범 커버 교체·제거의 상세는 `docs/specs/005-track-edit-dialog.md`를 따른다 (2026-09-14 구현 완료, UI·재시작 수동 확인 대기).
...
- 후속 스펙: [`012-nsis-installer.md`](../specs/012-nsis-installer.md) (NSIS exe 채널 추가, uv·Deno·yt-dlp 초기화 다운로드, NSIS URL 임포트 확장; 설계 완료·구현 미착수)
